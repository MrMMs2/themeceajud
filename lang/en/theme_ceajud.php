 ...
 * @package    theme
 * @subpackage ceajud
 * @copyright  2015 CEAJUD <leo.santos@cnj.jus.br>
...
<div class="clearfix">
<div class="well">
<h2>CEAJUD Responsive</h2>
<p><img class=img-polaroid src="ceajud/pix/screenshot.png" /></p>
</div>
<div class="well">
<h3>About</h3>
...
<h3>Created by</h3>
<p>This theme was developed and maintained by the CEAJUD CNJ staff.<br /> Responsible Technician: Leo Santos Renis <leorenis@gmail.com> </p>
</div></div>';

$string['configtitle'] = 'CEAJUD';
...
$string['enablehomedesc'] = 'Enable link home in navbar';
$string['enablemyhomedesc'] = 'Enable link my home in navbar';
$string['enableeventsdesc'] = 'Enable link events in navbar';
$string['enablemysitesdesc'] = 'Enable link my courses in navbar';
$string['enablethiscoursedesc'] = 'Enable link this course in navbar';
...
$string['usernavheading'] = 'User navbar heading';
$string['usernavdesc'] = 'Customize the users navigation bar.';

$string['breadcrumb'] = 'Breadcrumb';
$string['breadcrumbdesc'] = 'Sets the color of links with the path taken by the user.';

$string['activebreadcrumb'] = 'Breadcrumb active';
$string['activebreadcrumbdesc'] = 'Sets the color of active breadcrumb link.';
...
$string['accesstoinformation'] = 'Access to information';
$string['judiciary'] = 'Judiciary';
