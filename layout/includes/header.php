 ...
 * @package    theme
 * @subpackage ceajud
 * @copyright  2015 Leo Santos CEAJUD <leo.santos@cnj.jus.br>
...
theme_ceajud_initialise_zoom($PAGE);
$setzoom = theme_ceajud_get_zoom();

theme_ceajud_initialise_full($PAGE);
$setfull = theme_ceajud_get_full();
...
$paththeme = $CFG->wwwroot.'/theme/'. $PAGE->theme->name;

// Get the HTML for the settings bits.
$html = theme_ceajud_get_html_for_settings($OUTPUT, $PAGE);
...
<head>
    ...
    <link href="<?php echo $paththeme; ?>/style/font-awesome.min.css" rel="stylesheet">
    <!--<link href="<?php echo $paththeme; ?>/style/jquery-ui.min.css" rel="stylesheet"> Desable Jquery ui CSS-->
    <link href='//fonts.googleapis.com/css?family=Droid+Sans:400,700' rel='stylesheet' type='text/css'>
    <?php echo $OUTPUT->standard_head_html() ?>
    <!--<script type="text/javascript" src="<?php echo $paththeme; ?>/jquery/jquery-ui.min.js"></script> Desable Jquery ui JS--> 
...
<header id="page-header-wrapper" <?php if($fixedheader) { ?> style="position: fixed;" <?php } ?>>
            ...
            <div class="headermenu row">
                ...
                <?php } else { ?>
                    <div class="dropdown secondone">
                        <a href="#" class="dropdown-toggle usermendrop" data-toggle="dropdown" data-target=".secondone">
                        ...
                        <ul class="dropdown-menu usermen" role="menu">
                            ...
                            <?php if (!empty($PAGE->theme->settings->enableprofile)) { ?>
                                <li><a href="<?php p($CFG->wwwroot) ?>/user/profile.php" title="View profile"><i class="fa fa-user"></i><?php echo get_string('profile') ?></a></li>
                            <?php } ?>
    ...
    if (isset($PAGE) && !$PAGE->theme->settings->sitetitle) {
        $header = theme_ceajud_remove_site_fullname($PAGE->heading);
    ...
    ?>
     ...
     <span title='<?php echo $PAGE->heading ?>'><?php echo $PAGE->heading ?></span>
        ...
        <!-- TAG BUSCA DE CURSOS - Nao utilizada no momento.
        <div class="searchbox">
        ...
        <?php if ( isloggedin() ): ?>
	         ...
	         <div class="conteiner-user">
	         	<?php echo html_writer::tag('div', $OUTPUT->user_picture($USER, array('size'=>60)), array('class'=>'userimg')); ?>
	         	
	         	<div class="userdetails">
	         		<label><?php echo get_string('usergreeting', 'theme_ceajud'). $USER->firstname; ?></label>
	         		<div class="prolog">
	         			<?php
	         				echo html_writer::start_tag('div', array('class'=>'prolog'));
         ...
         <?php 
         		...
         		echo html_writer::start_tag('div', array('class'=>'userdetails_loggedout'));
	            $loginlink = html_writer::link(new moodle_url('/login/'), get_string('loginhere', 'theme_ceajud'));
	            echo html_writer::tag('h1', get_string('welcome', 'theme_ceajud').', '. $loginlink);
	            echo html_writer::end_tag('div');
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="nav-collapse collapse ">
                            ...
                            <ul class="nav pull-right">
                                ...
                                ?>
                                <li class="hbl"><a href="#" class="moodlezoom"><i class="fa fa-indent fa-lg"></i> <span class="zoomdesc"><?php echo get_string('hideblocks', 'theme_ceajud') ?></span></a></li>
                                <li class="sbl"><a href="#" class="moodlezoom"><i class="fa fa-outdent fa-lg"></i> <span class="zoomdesc"><?php echo get_string('showblocks', 'theme_ceajud') ?></span></a></li>
                                <li class="hbll"><a href="#" class="moodlewidth"><i class="fa fa-expand fa-lg"></i> <span class="zoomdesc"><?php echo get_string('fullscreen', 'theme_ceajud') ?></span></a></li>
                                <li class="sbll"><a href="#" class="moodlewidth"><i class="fa fa-compress fa-lg"></i> <span class="zoomdesc"><?php echo get_string('standardview', 'theme_ceajud') ?></span></a></li>
                            </ul>
