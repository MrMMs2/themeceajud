...
class ceajud_setting_confightmleditor extends admin_setting_configtext {
    private $rows;
    private $cols;
    private $options;
    private $filearea;
     ...
     */
    public function __construct($name, $visiblename, $description, $defaultsetting, $paramtype=PARAM_RAW, $cols='60', $rows='8', $filearea = 'ceajudmarketingimages') {
        $this->rows = $rows;
        $this->cols = $cols;
