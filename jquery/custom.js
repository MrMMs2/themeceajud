...
var onZoom = function() {
  ...
  if (zoomin) {
    ...
    M.util.set_user_preference('theme_ceajud_zoom', 'nozoom');
  } else {
    Y.one('body').addClass('zoomin');
    M.util.set_user_preference('theme_ceajud_zoom', 'zoomin');
  }
};

//When the button with class .moodlezoom is clicked fire the onZoom function
M.theme_ceajud = M.theme_ceajud || {};
M.theme_ceajud.zoom =  {
  init: function() {
...
var onFull = function() {
    if ( $("#page").hasClass("fullin") ) {
        ...
        M.util.set_user_preference('theme_ceajud_full', 'nofull');
    } else {
        $( "#page").addClass('fullin');
        //Y.one('#page').addClass('fullin');
        M.util.set_user_preference('theme_ceajud_full', 'fullin');
    }
};
